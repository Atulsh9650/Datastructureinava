...
public class Isbalancedtree {
	...
	public static Balancedbinarytee isbalancedbetter(Binarytreenode<Integer> root) {
		if(root==null) {
			int height=0;
			boolean isbal=true;
			Balancedbinarytee ans=new Balancedbinarytee();
			ans.height=height;
			ans.isbalanced=isbal;
			return ans;
		}
		Balancedbinarytee leftoutput=isbalancedbetter(root.left);
		Balancedbinarytee rightoutput=isbalancedbetter(root.right);
		boolean isbal=true;
